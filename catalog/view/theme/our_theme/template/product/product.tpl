        ...
        <div class="<?php echo $class; ?>">
          ...
          <div class="rating">
            <p>
              ...
              <?php } ?>
              <a href=""
                onclick="$('a[href=\'#tab-review\']').trigger('click'); return false;"><?php echo $reviews; ?></a> / <a
                href=""
      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          <div class="product-thumb transition">
            ...
            <?php if ($product['special']) { ?>
            <?php echo "Это акционный товар"?>
            <?php } ?>
            <div class="button-group">
              <button type="button" onclick="cart.add('<?php echo $product['product_id']; ?>');"><i
                  class="fa fa-shopping-cart"></i> <span class="hidden-xs hidden-sm hidden-md"></span></button>
            </div>
          </div>
        </div>
        <?php } ?>
